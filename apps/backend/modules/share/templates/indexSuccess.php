			...
			<div>
				...
				<table class="list-table hoverchangle" cellspacing="0"
				    ...
				    <tr>
						...
						<?php echo link_to('推荐','@share_rank?id='.$object->getId())?>
						<?php else :?>
						<?php echo link_to('取消推荐','@share_unrank?id='.$object->getId())?>
						<?php endif;?>
				    ...
				    <tr>
				    	...
				    	<td colspan="4">
				    		...
				    		<a
								href="<?php echo url_for('@pager?module=share&action=index'.$ex_param.'&page='.$pager->getLastPage());?>">末页</a>
							</td>
					</tr>
					<?php endif;?>
					</tbody>
