...
/**
 * DownloadRecords form base class.
 *
 * @method DownloadRecords getObject() Returns the current form's model object
 *
 * @package    bzr
 * @subpackage form
 * @author     gefei
 ...
 */
abstract class BaseDownloadRecordsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('download_records[%s]');
